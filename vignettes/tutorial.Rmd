...
lm2 is a function that is designed to perform linear model regressions. A data set containing information regarding red wine quality named "wine" is included in this package for examples and tutorials.
    
**Call the function and assign to exlm2** *Note: na.action defaults to omit if call is excluded*
```{r}
...
```{r}
lm2(formula = quality ~ volatile.acidity * citric.acid , data = wine, na.action = 'fail')
```
